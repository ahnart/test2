...
<script type="text/javascript">
	...
	function goPageNo(pageNo) {
		$("#page").val(pageNo);
		$("#frm").attr("action", "/send/sendList.do");
		$("#frm").submit();
	}
	...
	function goDetail(sendMngNo) {
		commonGetUrl('/send/sendDetail.do', 'sendmngno=' + sendMngNo
				+ '&listpage=' + iCurrPage);
	}
	...
	<div id="wrap">
		...
		<section id="container" class="clearfix">
			...
			<section id="section">
				<!-- gnb start -->
				<div class="bradcrumb">
					<a href="/">SISCUS</a> &gt; <a href="/send/campaignList.do">발송관리</a> &gt; <a href="/send/sendList.do" class="on">발송관리</a>
				</div>
				<!-- gnb end -->
				<form name="frm" id="frm" method="post">
					<input type="hidden" id="sendMngNo" name="sendMngNo" /> <input type="hidden" id="page" name="page" value="" /> <input type="hidden" id="pagecount" name="pagecount" value="" /> <input
					...
					<div class="search clearfix">
						<div class="half-col">
							<div class="row">
								<strong>발송관리</strong>
								<div class="calendar">
									<input type="text" name="start_date" id="start_date" value="2020-01-12" class="datepicker01">
								</div>
								<span> ~ </span>
								<div class="calendar">
									<input type="text" name="end_date" id="end_date" value="2020-04-21" class="datepicker02">
								</div>
							</div>
							<div class="row">
								<strong>캠페인명</strong> <input type="text" name="campaignname" id="campaignname" value="" />
							</div>
							<div class="row">
								<strong>발송명</strong> <input type="text" name="sendmngname" id="sendmngname" value="" />
							</div>
						</div>
						<div class="half-col">
							<div class="row">
								<strong>캠페인상태</strong> <select name="campaignstatus">
									<option value="" selected>전체</option>
									<option value="Y">캠페인중</option>
									<option value="N">캠페인종료</option>
								</select>
							</div>
							<div class="row">
								<strong>캠페인번호</strong> <input type="text" name="campaignmngno" id="campaignmngno" value="" />
							</div>
							<div class="row">
								<strong>발송번호</strong> <input type="text" name="sendmngno" id="sendmngno" value="" />
							</div>
